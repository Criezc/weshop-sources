<?php
    ...
    if($totalBarang == 0){
        echo "<h3>There Is No Item In Cart</h3>";
    }else{
        ...
        echo "<table class='table-list'>
                ...
                foreach($keranjang AS $key => $value){
                    ...
                    echo "<tr> 
                            ...
                            <td class='temgah'><input type='text' name='$barang_id' value='$quantity' class='update-quantity' /></td>
                ...
                echo "<div id='frame-button-keranjang'>
                        ...
                        <a id='lanjut-pemesanan' href='".BASE_URL."data-pemesanan.html'>Lanjut Pemesanan></a>
                    </div>";
