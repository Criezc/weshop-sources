<?php
    ...
    if(mysqli_num_rows($queryPesanan) == 0) {
        echo "<h3>There is no order data for now</h3>";
        ...
        while($row=mysqli_fetch_assoc($queryPesanan)) {
            ...
            if($level == "superadmin"){
                $adminButton = "<a class='tombol-detail' href='".BASE_URL."index.php?page=my_profile&module=pesanan&action=status&pesanan_id=$row[pesanan_id]'>Update Status</a>";
            }
            ...
            echo "<tr>
                    ...
                    <td class='kiri'>
                        <a class='tombol-detail' href='".BASE_URL."index.php?page=my_profile&module=pesanan&action=detail&pesanan_id=$row[pesanan_id]'>Detail Pesanan</a>
                        $adminButton
                    </td>
                </tr>";
        }
